  ...
  return (
    <DashboardLayout>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-slate-900">245</dd>
              </dl>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-slate-900">1,234</dd>
              </dl>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-slate-100">
          <div className="flex items-center">
            <div className="flex-shrink-0 bg-gradient-to-br from-teal-400 to-teal-500 rounded-lg p-3 shadow-md">
              <svg className="h-6 w-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="ml-5 w-0 flex-1">
              <dl>
                ...
                <dd className="text-2xl font-semibold text-slate-900">$45,678</dd>
              </dl>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-md p-6 border border-slate-100">
          <h2 className="text-xl font-semibold text-slate-900 mb-4">Informations du compte</h2>
          <div className="space-y-3">
            ...
            <div className="flex justify-between py-2 border-b border-slate-200">
              ...
              <span className="px-3 py-1 bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-full text-sm font-semibold shadow-md">
                {user.role}
              </span>
            </div>
            <div className="flex justify-between py-2">
              <span className="text-slate-600 font-medium">Session ID:</span>
              <span className="text-slate-500 font-mono text-xs">{user.sessionId}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 border border-slate-100">
          ...
          <div className="space-y-3">
            <Link
              to="/dashboard/users"
              className="w-full px-4 py-3 bg-teal-50 text-teal-700 rounded-lg hover:bg-teal-100 hover:shadow-md transition-all text-left flex items-center space-x-3"
            >
            ...
            >
              ...
              <span className="font-medium">Gérer les codes promo</span>
            </Link>
            <Link
