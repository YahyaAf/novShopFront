  ...
  return (
    <DashboardLayout>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Gestion des Codes Promo</h1>
          <p className="text-slate-600 mt-1">Créez et gérez vos codes promotionnels</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow-md p-4 border border-slate-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-500">Total Codes</p>
              <p className="text-2xl font-bold text-slate-900">{stats.totalPromos}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 border border-slate-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-500">Épuisés</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-4 border border-slate-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-500">Utilisations</p>
              <p className="text-2xl font-bold text-slate-900">{stats.totalUsage}</p>
              <p className="text-xs text-slate-500">/ {stats.totalCapacity}</p>
            </div>
          </div>
        </div>
      </div>
